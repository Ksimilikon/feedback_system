...
<head>
    ...
    <script src="../../js/search_browse.js" defer></script>
    <title>Не решенные заявки</title>
</head>
<body>
    <?php
    insertHeader('', '');
                ...
                <div class="flex row space-btw">
                    ...
                    if($numPage==1){
                        ...
                        if($num_rows<7){
                            ...
                            echo '<a href="browse.php?page='.$target.'">>>></a>';
                        }
                    ...
                    if($numPage>1){
                        ...
                        if($num_rows == 7){
                            echo '<a href="browse.php?page='.$targetMinus.'"><<<</a>';
                            echo '<a href="browse.php?page='.$targetPlus.'">>>></a>'; 
                        }
                        else{
                            echo '<a href="browse.php?page='.$targetMinus.'"><<<</a>';
                            echo '<p>>>></p>';
